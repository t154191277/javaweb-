...
function(a, b) {
    function c(b) {
        ...
        if (d.innerHTML = u(b.title).split("\n").join("<br>"), e.innerHTML = u(b.text || "").split("\n").join("<br>"), b.text && w(e), y(c.querySelectorAll(".icon")), b.type) {
            for (var h = !1,
            i = 0; i < n.length; i++) if (b.type === n[i]) {
                h = !0;
                break;
            }
            if (!h) return a.console.error("Unknown alert type: " + b.type),
            !1;
        ...
        if (b.imageUrl) {
            ...
            k.style.backgroundImage = "url(" + b.imageUrl + ")",
            w(k);
            var l = 80,
            m = 80;
            if (b.imageSize) {
    ...
    function f() {
        ...
        t(e, "animateErrorIcon"),
        t(e.querySelector(".x-mark"), "animateXMark");
    ...
    function() {
        "complete" === b.readyState || "interactive" === b.readyState && b.body ? sweetAlertInitialize() : b.addEventListener ? b.addEventListener("DOMContentLoaded",
        function a() {
            b.removeEventListener("DOMContentLoaded", a, !1),
            sweetAlertInitialize()
        },
        !1) : b.attachEvent && b.attachEvent("onreadystatechange",
        function c() {
